...
int main()
{
	ofstream fresult("Result_density/result.data", ios::out);
	ofstream fresult_Gn("Result_density/result_Gn.data", ios::out);
	ofstream fresult_corrected("Result_density/result_corrected.data", ios::out);
	ofstream fgamma0("Result_density/gamma0.data", ios::out);
	ofstream fm_theo("Result_density/m_theo.data", ios::out);
	ofstream fsigma_theo("Result_density/sigma_theo.data", ios::out);
	ofstream fa_n("Result_density/a_n.data", ios::out);
